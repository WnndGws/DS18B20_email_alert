...
def log_temps():
    ...
    if (logger.hasHandlers()):
        ...
        handler = logging.handlers.TimedRotatingFileHandler("/home/pi/RPI-Temp-sensor/DS18B20_email_alert/logging/logs/freezer01_temperature.log", when="midnight", interval=1, backupCount=365)
